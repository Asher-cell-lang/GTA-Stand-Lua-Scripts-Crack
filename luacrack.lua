...
function check_version()
    ...
    local daidai_github_url = "https://gh.jasonzeng.dev/https://raw.githubusercontent.com/Asher-cell-lang/GTA-Stand-Lua-Scripts-Crack/refs/heads/main/versions.txt"
    local daidai_version_url = "http://check.cnsakura.top/stand/versions.txt"

    local GT_github_url = "https://gh.jasonzeng.dev/https://raw.githubusercontent.com/Asher-cell-lang/GTA-Stand-Lua-Scripts-Crack/refs/heads/main/versions.txt"
